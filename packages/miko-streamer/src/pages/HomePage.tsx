...
export default function HomePage() {
  ...
  return (
    <>
      <Helmet>
        <title>MIKO-STREAMER | Homepage</title>
      </Helmet>
      <Center w="full" h="full" position="relative">
        <Container maxW={'4xl'}>
          <Stack as={Box} textAlign={'center'} spacing={{ base: 8, md: 14 }} py={{ base: 20, md: 36 }}>
            ...
            <Text color="gray.200">
              Welcome to Miko. This website is dedicated to streamers. Streamers provide services to register and manage concerts. Discover, stream, and share a constantly
              expanding mix of concert from emerging and major artists around the world.
            </Text>
